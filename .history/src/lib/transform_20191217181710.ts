...
function getVariableType (variable:{[props:string]:string}, name:string):string {
...
`;
function generateInterface (prefName:string, variable:{[props:string]:string}, indent:string) {
